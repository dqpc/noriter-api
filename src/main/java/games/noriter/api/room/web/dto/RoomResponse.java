...
public record RoomResponse(
    ...
    public record Player(String id, String nickname, String character, long score, boolean finished, Integer rank) {}
    ...
    public static RoomResponse from(RoomSnapshot s) {
        ...
        return new RoomResponse(
                ...
                s.players().stream().map(p -> new Player(p.id(), p.nickname(), p.character(), p.score(), p.finished(), p.rank())).toList());
    }
}
